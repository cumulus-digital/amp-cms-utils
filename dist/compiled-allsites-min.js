 ...
 */
function(o,t){function log(){window._CMLS.logger(e+" v"+i,arguments)}function fireEvent(t,e,o){try{log("Event fired: "+t,e,o),sharedContainerDataLayer.push({event:t,"page-visible":e,"time-change":o}),corpDataLayer.push({event:t,"page-visible":e,"time-change":o})}catch(t){}}function handleVisibilityChange(t){var e=Math.round((o._CMLS.now()-s)/1e3);!0!==t&&!1!==t&&(t=!o.document[r]),fireEvent("page-visibility",t,e),s=o._CMLS.now()}var e="GTM TAB VISIBILITY TRACKING",n="GTMTabVisibilityTracker",i="0.1",r,a;window._CMLS[n]=!0,void 0!==o.document.hidden?(// Opera 12.10 and Firefox 18 and later support 
